...
Actions = GridWorldMDP.Directions
ni = -np.inf
...
class TestTransitionProbabilities(TestCase):
    ...
    def test_simple(self):
        ...
        act_probs = np.zeros([g.S, g.A])
        act_probs[s, g.Directions.RIGHT] = 0.5
        act_probs[s, g.Directions.UP] = 0.5
    ...
    def test_clockwise(self):
        ...
        P = np.zeros([g.S, g.A])
        P[A, g.Directions.RIGHT] = 1
        P[B, g.Directions.DOWN] = 1
        P[C, g.Directions.LEFT] = 1
        P[D, g.Directions.UP] = 1
